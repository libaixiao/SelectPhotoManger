...
+ (instancetype)_colorWithHex:(uint32_t)hex {
    ...
    return [self _colorWithRed:r green:g blue:b];
}

+ (instancetype)_randomColor {
    return [UIColor _colorWithRed:arc4random_uniform(256) green:arc4random_uniform(256) blue:arc4random_uniform(256)];
}
...
+ (UIColor*)_gradientFromColor:(UIColor*)c1 toColor:(UIColor*)c2 withHeight:(CGFloat)height
{
